...
CREATE UNIQUE INDEX `user_id_UNIQUE` ON `restaurant`.`address` (`user_id` ASC) VISIBLE;
...
insert into address(id, country, city, street, building_number, user_id)
values (default, "USA", "Seattle", "Washington", "1111", 1),
       (default, "USA", "Seattle", "5th", "25", 2),
       (default, "USA", "Washington", "1st", "84", 3),
       (default, "Canada", "Torronto", "Queen Elizabeth", "1", 4),
       (default, "USA", "New Jersey", "Bank", "11/45", 5);
